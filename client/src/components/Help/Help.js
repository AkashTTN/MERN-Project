                ...
                <section className="SocialMedia ContentSection">
                    ...
                    <ul className="SocialMediaList">
                        <li className="SocialMediaListItem">
                            <a href="https://www.facebook.com/TOTHENEWDigital/" target="_blank">
                                <i class="fab fa-facebook-f fa-2x"></i>
                            </a>
                        </li>
                        <li className="SocialMediaListItem">
                            <a href="https://twitter.com/tothenew" target="_blank">
                                <i class="fab fa-twitter fa-2x"></i>
                            </a>
                        </li>
                        <li className="SocialMediaListItem">
                            <a href="https://www.linkedin.com/company/tothenew" target="_blank">
                                <i class="fab fa-linkedin-in fa-2x"></i>
                            </a>
                        </li>
                        <li className="SocialMediaListItem">
                            <a href="https://www.youtube.com/c/tothenew" target="_blank">
